...
public class PlacesService {
    ...
    public List<Places> findPlaces(double latitude, double longitude,String placeSpacification)
    {
        ...
        try {
            ...
            for (int i = 0; i < array.length(); i++) {
                try {
                    Places place = Places.jsonToPontoReferencia((JSONObject) array.get(i));
